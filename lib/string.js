 ...
 * reuse the key idea and apply it in many situations
 * 
 * Used to find unique sequences like:
 * min/max tracking,
 ...
 * 
 * naive will gives us O(n*m) time
 * kmp gives O(m + n) time
 * 
 * idea: avoid re-checking characters we already know match
 * 
 */
